...
class CirclePageIndicator @JvmOverloads constructor(
    ...
    init {
        ...
        mCentered = a.getBoolean(
            R.styleable.CirclePageIndicator_centered,
            defaultCentered
        )
        ...
        mPaintStroke.color = a
            .getColor(
                R.styleable.CirclePageIndicator_strokeColor,
                defaultStrokeColor
            )
        mPaintStroke.strokeWidth = a
            .getDimension(
        ...
        mRadius = a.getDimension(
            R.styleable.CirclePageIndicator_radius,
            defaultRadius
        )
    ...
    override fun onTouchEvent(ev: android.view.MotionEvent): Boolean {
        ...
        when (action and MotionEventCompat.ACTION_MASK) {
            ...
            MotionEventCompat.ACTION_POINTER_UP -> {
                ...
                val pointerId = MotionEventCompat.getPointerId(
                    ev,
                    pointerIndex
                )
